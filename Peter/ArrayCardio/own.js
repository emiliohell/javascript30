...
const inventorAge = inventors.sort((a, b) => (a.year > b.year ? "1" : "-1"));
...
const totalYears = inventors.reduce((acc, val) => acc + (val.passed - val.lived),0);
...
// console.table(yearsLived)
    ...
    //First approach
const byLastName = people.sort(function(a, b) {
